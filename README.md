...
W katalogu głównym powinien być skrót do pliku wykonywalnego "SystemPrzychodznia.exe". 

Jeśli skrót nie jest dostępny, można go znaleźć w katalogu "SystemPrzychodznia/bin/Debug/net10.0-windows".
